    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <button class="btn btn-outline-danger my-2 my-sm-0" onclick="collectionsApp.logOut()">Αποσυνδέση</button>
            </form>
        </div>
    </div>
</nav>
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${list}" var="row">
                <tr>
                    ...
                    <td>${row.restOfAmount}</td>
                    <td>${row.date}</td>
                    <td><a href="${row.receipt}"><img src="${row.receipt}" style="width:65px;height:65px;"></a></td>
                    <spring:url value="${pageContext.request.contextPath}/collections/delete/${row.collectionID}" var="deleteURL"/>
                    <td><button type="button" class="btn btn-danger" onclick="location.href='${deleteURL}'">Διαγραφή</button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <button class="btn btn-outline-info my-2 my-sm-0" id="reportCollection" name="reportCollection">Δημιουργία αναφοράς PDF</button>
    </div>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/resources/js/collection.js"></script>
</body>
</html>
