...
<div class="container">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${list}" var="row">
                <tr>
                    <td>${row.name}</td>
                    <spring:url value="${pageContext.request.contextPath}/buytypes/delete/${row.buyTypeID}" var="deleteURL"/>
    ...
    <h2>Νέο είδος αγοράς</h2>
    <hr>
    <form:form>
        <div class="form-group">
            <label for="nameInput">Όνομα</label>
            <input type="text" class="form-control" id="nameInput" maxlength="20" minlength="1" name="nameInput" placeholder="Name">
        </div>
        <div class="form-group">
