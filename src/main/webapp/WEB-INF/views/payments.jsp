    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <button class="btn btn-outline-danger my-2 my-sm-0" onclick="paymentApp.logOut()">Αποσυνδέση</button>
            </form>
        </div>
    </div>
</nav>
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${list}" var="row">
                <tr>
                    ...
                    <spring:url value="${pageContext.request.contextPath}/payments/delete/${row.paymentID}" var="deleteURL"/>
                    <td><button type="button" class="btn btn-danger" onclick="location.href='${deleteURL}'">Διαγραφή</button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <button class="btn btn-outline-info my-2 my-sm-0" id="reportPayment" name="reportPayment">Δημιουργία αναφοράς PDF</button>
    </div>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/resources/js/payment.js"></script>
</body>
</html>
