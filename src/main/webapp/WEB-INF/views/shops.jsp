    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <button class="btn btn-outline-danger my-2 my-sm-0" onclick="shopsApp.logOut()">Αποσυνδέση</button>
            </form>
        </div>
    </div>
</nav>
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${list}" var="row">
                <tr>
                    ...
                    <td>${row.telephone}</td>
                    <td>${row.vat}</td>
                    <spring:url value="${pageContext.request.contextPath}/shops/delete/${row.shopID}" var="deleteURL"/>
                    <td><button type="button" class="btn btn-danger" onclick="location.href='${deleteURL}'">Διαγραφή</button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
        <button class="btn btn-outline-info my-2 my-sm-0" id="reportShops" name="reportShops">Δημιουργία αναφοράς PDF</button>
    </div>
...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/resources/js/shops.js"></script>
</body>
</html>