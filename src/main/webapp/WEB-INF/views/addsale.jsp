...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        ...
        <form:form>
            ...
            <div class="form-group">
                <label for="inputType">Είδος πώλησης</label>
                <select id="inputType" name="inputType" class="form-control">
                    <c:forEach items="${saleTypesList}" var="saleType">
                        <option value="${saleType.name}" selected>${saleType.name}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="form-group row">
                <label for="inputValue" class="col-sm-2 col-form-label">Ποσό πώλησης</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="inputDate" name="inputDate" value="2018-01-01" min="1000-01-01" max="3000-12-31" placeholder="Date">
                </div>
            </div>
            <div class="form-group">
